...
urlpatterns = patterns('',
    ...
    (r'^storm/$',views.storm),
     (r'^ram/$',views.ram_about),
     (r'^ram_html/$',views.ram_html),
     (r'^ram_check_result/$',views.ram_check_result),
   ...
   # (r'^attention_letters_html/$',views.attention_letters_html),
    ...
    (r'^double_images_result/$',views.double_images_result), 
     ...
     (r'^reset_result/$',views.reset_result),
     # (r'^result_html/$',views.result_html),
    (r'^summ/$',views.summ),
    # Examples:
